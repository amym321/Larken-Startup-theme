...
function () {
  ...
  StaticSlideshow_createClass(StaticSlideshow, [{
    ...
    value: function setupHeader($el) {
      ...
      if ($el && $el[0].hasAttribute('data-full-bleed-slideshow')) {
...
function () {
  function DynamicProduct(section) {
    ...
    this.$slideshow = jquery_default()('[data-slideshow-container]', this.$el);
    ...
    if (this.$slideshow.length) {
      this.slideshowSection = section.el.querySelector('.product-slideshow-section');
...
/***/ })
/******/ ]);
//# sourceMappingURL=startup.js.map?1568323352412